...
#
# PURPOSE:      Build input topology and attributes for the GSFLOW
#               groundwater--surface-water model
#
# COPYRIGHT:    (c) 2015, 2016, 2017 Andrew Wickert
#
...
#%  key: E
#%  type: double
#%  description: Basin mouth easting
#%  required : yes
#%end
...
#%  key: N
#%  type: double
#%  description: Basin mouth northing
#%  required : yes
#%end
